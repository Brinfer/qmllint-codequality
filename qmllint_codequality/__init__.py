...
class Diagnostic:
    ...
    def to_code_quality(self) -> dict[str, Union[str, int, list, dict]]:
        ...
        Returns:
            dict[str, Union[str, int, list, dict]]: A dictionary representing the Code Quality violation.
        """
        code_quality: dict = {
...
def _convert_json(json_input: dict) -> tuple[list[dict], int]:
    ...
    Arguments:
        json_input -- qmllint JSON report.

    Returns:
        A list of dictionary, and the number of violation.
    """
...
def convert_file(input_file_path: str, output_file_path: str) -> int:
    ...
    Args:
        input_file_path (str): Input file path (qmllint JSON).
        output_file_path (str): Output file path (Code Quality JSON).

    Returns:
        int: If processing failed, a negative value. If successful, number of qmllint issues processed.
    """
